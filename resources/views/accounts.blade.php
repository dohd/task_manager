...
<div class="sidenav">
    ...
    <a href="/add_project" style="margin-top: 15px;">Add Project</a>
    <a href="/manage_projects" style="margin-top: 15px;">Manage Projects</a>
    <a href="#" style="margin-top: 15px;">Event Calendar</a>
    <a href="project_reports" style="margin-top: 15px;">Project Reports</a>
    <a href="#" style="margin-top: 15px;">Project Visualization</a>
    <a href="/account" style="margin-top: 15px;">Account</a>
